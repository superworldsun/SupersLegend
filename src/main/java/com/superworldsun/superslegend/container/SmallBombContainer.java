...
public class SmallBombContainer extends Container
{
	...
	public SmallBombContainer(int windowId, PlayerInventory playerInventory, Hand activeHand)
	{
		super(ContainerInit.SMALL_BOMB_BAG.get(), windowId);
	...
	public SmallBombContainer(int windowId, PlayerInventory playerInventory, PacketBuffer additionalData)
	{
