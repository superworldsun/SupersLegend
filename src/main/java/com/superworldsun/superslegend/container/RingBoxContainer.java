...
public class RingBoxContainer extends Container
{
	...
	public RingBoxContainer(int windowId, PlayerInventory playerInventory, Hand activeHand)
	{
		...
		for (int j = 0; j < 9; ++j)
		{
			addSlot(new BagSlot(bagInventory, j, 8 + j * 18, 36, bagItem));
		}
	}
	...
	{
		WHOLE_INVENTORY(0, 36), INVENTORY(0, 27), HOTBAR(27, 9), BAG(36, 9);
