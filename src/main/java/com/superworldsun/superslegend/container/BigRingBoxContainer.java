...
public class BigRingBoxContainer extends Container
{
	...
	public BigRingBoxContainer(int windowId, PlayerInventory playerInventory, Hand activeHand)
	{
		...
		for (int i = 0; i < 2; i++)
		{
			for (int j = 0; j < 9; ++j)
			{
				addSlot(new BagSlot(bagInventory, j + i * 9, 8 + j * 18, 27 + i * 18, bagItem));
			}
		}
	}
	...
	{
		WHOLE_INVENTORY(0, 36), INVENTORY(0, 27), HOTBAR(27, 9), BAG(36, 18);
