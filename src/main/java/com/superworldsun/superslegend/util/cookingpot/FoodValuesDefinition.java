...
public class FoodValuesDefinition extends AbstractCookingPotRecipe {
        ...
        ImmutableSortedSet.Builder<Item> builder = ImmutableSortedSet.orderedBy((i1, i2) -> {
            ...
            if (MathUtils.fuzzyEquals(v1, v2)) {
                if ("minecraft".equals(n1)) {
                    ...
                    return 1;
                } else if (SupersLegendMain.MOD_ID.equals(n1)) {
                    return SupersLegendMain.MOD_ID.equals(n2) ? r1.compareTo(r2) : -1;
                } else if (SupersLegendMain.MOD_ID.equals(n2)) {
                    return 1;
                } else {
