...
public class LongshotEntity extends AbstractArrowEntity {
     ...
     */
    private static final DataParameter<Integer> HOOKED_ENTITY_ID = EntityDataManager.defineId(LongshotEntity.class, DataSerializers.INT);
    ...
    public LongshotEntity(EntityType<LongshotEntity> longshotEntityEntityType, World world) {
