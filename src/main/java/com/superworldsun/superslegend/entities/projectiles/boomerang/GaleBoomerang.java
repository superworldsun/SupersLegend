...
public class GaleBoomerang extends GaleBoomerangEntity {
	...
	public static EntityType<GaleBoomerangEntity> createEntityType()
	{
		return EntityType.Builder.<GaleBoomerangEntity>of(GaleBoomerang::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(SupersLegendMain.MOD_ID + ":gale_boomerang");
	}
}