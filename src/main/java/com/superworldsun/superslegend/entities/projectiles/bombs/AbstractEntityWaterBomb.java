...
public abstract class AbstractEntityWaterBomb extends ProjectileItemEntity {
    ...
    public AbstractEntityWaterBomb(EntityType<? extends AbstractEntityWaterBomb> type, World world, float secondsToExplode, float secondsToFlashRapidly, int explosionPower, double bounceDampeningFactor) {
        super(type, world);
    ...
    public AbstractEntityWaterBomb(EntityType<? extends AbstractEntityWaterBomb> entityType, LivingEntity shooter, World world, float secondsToExplode, float secondsToFlashRapidly, int explosionPower, double bounceDampeningFactor) {
