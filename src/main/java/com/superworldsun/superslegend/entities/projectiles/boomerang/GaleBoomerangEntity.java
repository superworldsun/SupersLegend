...
public abstract class GaleBoomerangEntity extends Entity {
    ...
    private Hand hand;
    private static final DataParameter<Float> ROTATION = EntityDataManager.defineId(GaleBoomerangEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Optional<UUID>> RETURN_UNIQUE_ID = EntityDataManager.defineId(GaleBoomerangEntity.class, DataSerializers.OPTIONAL_UUID);

    public GaleBoomerangEntity(EntityType<GaleBoomerangEntity> type, World world) {
        super(type, world);
    ...
    public GaleBoomerangEntity(EntityType<GaleBoomerangEntity> type, World worldIn, PlayerEntity entity, ItemStack itemstack, Hand hand) {
        this(type, worldIn);
    ...
    public abstract DamageSource causeNewDamage(GaleBoomerangEntity entityboomerang, Entity entity);
