...
@OnlyIn(Dist.CLIENT)
public class MagicBoomerangRender extends EntityRenderer<MagicBoomerangEntity> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/item/magic_boomerang.png");

    private final ItemRenderer itemRenderer = Minecraft.getInstance().getItemRenderer();

    public MagicBoomerangRender(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public void render(MagicBoomerangEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    private ItemStack getItemStackForRender(MagicBoomerangEntity entityIn) {
        return new ItemStack(ItemInit.MAGIC_BOOMERANG.get());
    }
