...
public abstract class WWBoomerangEntity extends Entity {
    ...
    private Hand hand;
    private static final DataParameter<Float> ROTATION = EntityDataManager.defineId(WWBoomerangEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Optional<UUID>> RETURN_UNIQUE_ID = EntityDataManager.defineId(WWBoomerangEntity.class, DataSerializers.OPTIONAL_UUID);

    public WWBoomerangEntity(EntityType<WWBoomerangEntity> type, World world) {
        super(type, world);
    ...
    public WWBoomerangEntity(EntityType<WWBoomerangEntity> type, World worldIn, PlayerEntity entity, ItemStack itemstack, Hand hand) {
        this(type, worldIn);
    ...
    public abstract DamageSource causeNewDamage(WWBoomerangEntity entityboomerang, Entity entity);
