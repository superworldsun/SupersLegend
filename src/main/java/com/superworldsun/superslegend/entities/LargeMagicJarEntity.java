...
public class LargeMagicJarEntity extends Entity {
    ...
    public LargeMagicJarEntity(World p_i1585_1_, double p_i1585_2_, double p_i1585_4_, double p_i1585_6_) {
    ...
    public LargeMagicJarEntity(EntityType<?> p_i48580_1_, World p_i48580_2_) {
     ...
     */
    //TODO add a custom sound effect for large magic pick up
    @Override
