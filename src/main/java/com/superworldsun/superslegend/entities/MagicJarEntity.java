...
public class MagicJarEntity extends Entity {
    ...
    public MagicJarEntity(Level p_i1585_1_, double p_i1585_2_, double p_i1585_4_, double p_i1585_6_) {
    ...
    public MagicJarEntity(EntityType<?> p_i48580_1_, Level p_i48580_2_) {
    ...
    public void playerTouch(@NotNull Player player) {
        if (!this.level().isClientSide)
        {
            ...
            {
                MagicProvider.restoreMagic(player, 3);
