package com.superworldsun.superslegend.worldgen.structures;
...
public class FairyFountainStructure extends Structure<NoFeatureConfig> {
    //Code credited to TelepathicGrunt
    public FairyFountainStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return FairyFountainStructure.Start::new;
    }
     ...
     */
    //Uncomment if you want to add mobs to the structure's mob spawning
...
//
    ...
    public static class Start extends StructureStart<NoFeatureConfig>  {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
             ...
             * If addPieces's last parameter isw true, blockpos's Y value is ignored and the
             * structure will spawn at terrain height instead. Set that parameter to false to
             * force the structure to spawn at blockpos's Y value instead. You got options here!
             */
            //EDIT: See here
            //This is a little trick to make the structures generate at a range of depths
            //This is one of the ways you can go about underground generation
            Random r = new Random();
            // low should be set to the structure's total height + 1
            // high should be probably around 64 - minus the structure's total height...so the highest y value
            // they would be found at is at 56 or below
            int low = 9;
            int high = 56;
            int result = r.nextInt(high-low) + low;
            BlockPos centerPos = new BlockPos(x, result, z);
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(SupersLegendMain.MOD_ID, "fairy_fountain/start_pool")),
            ...
            SupersLegendMain.LOGGER.log(Level.DEBUG, "Fairy Fountain at " +
