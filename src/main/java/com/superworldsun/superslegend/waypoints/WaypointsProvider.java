...
public class WaypointsProvider implements ICapabilitySerializable<CompoundNBT>
{
	...
	{
		INBT originalNBT = WAYPOINTS_CAPABILITY.writeNBT(WaypointsProvider.get(event.getOriginal()), null);
		WAYPOINTS_CAPABILITY.readNBT(WaypointsProvider.get(event.getPlayer()), null, originalNBT);
	}
