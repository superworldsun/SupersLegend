...
public class SupersLegendStructures {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES,
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> FAIRY_FOUNTAIN = DEFERRED_REGISTRY_STRUCTURE.register("fairy_fountain",
