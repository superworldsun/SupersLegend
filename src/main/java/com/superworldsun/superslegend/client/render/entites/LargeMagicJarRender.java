...
public class LargeMagicJarRender extends EntityRenderer<LargeMagicJarEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/entity/large_magic_jar.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public LargeMagicJarRender(EntityRendererProvider.Context pContext) {
        super(pContext);
