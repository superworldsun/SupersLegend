...
public class MagicJarRender extends EntityRenderer<MagicJarEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/entity/magic_jar.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public MagicJarRender(EntityRendererProvider.Context pContext) {
        super(pContext);
