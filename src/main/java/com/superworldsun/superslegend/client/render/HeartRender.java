...
import com.superworldsun.superslegend.client.model.HeartModel;
...
public class HeartRender extends EntityRenderer<HeartEntity> {
	...
	public void render(HeartEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
		...
		vertex(ivertexbuilder, matrix4f, matrix3f, -0.5F, -0.25F, 255, 0, 0, 0, 1, p_225623_6_);
		vertex(ivertexbuilder, matrix4f, matrix3f, 0.5F, -0.25F, 255, 0, 0, 1, 1, p_225623_6_);
		vertex(ivertexbuilder, matrix4f, matrix3f, 0.5F, 0.75F, 255, 0, 0, 1, 0, p_225623_6_);
		vertex(ivertexbuilder, matrix4f, matrix3f, -0.5F, 0.75F, 255, 0, 0, 0, 0, p_225623_6_);
		p_225623_4_.popPose();
	...
	private static void vertex(IVertexBuilder p_229102_0_, Matrix4f p_229102_1_, Matrix3f p_229102_2_, float p_229102_3_, float p_229102_4_, int p_229102_5_, int p_229102_6_, int p_229102_7_, float p_229102_8_, float p_229102_9_, int p_229102_10_) {
		p_229102_0_.vertex(p_229102_1_, p_229102_3_, p_229102_4_, 0.0F).color(p_229102_5_, p_229102_6_, p_229102_7_, 255).uv(p_229102_8_, p_229102_9_).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(p_229102_10_).normal(p_229102_2_, 1.0F, 1.0F, 1.0F).endVertex();
	}
}