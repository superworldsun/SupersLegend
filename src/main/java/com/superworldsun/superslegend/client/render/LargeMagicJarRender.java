...
public class LargeMagicJarRender extends EntityRenderer<LargeMagicJarEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(LargeMagicJarEntity entity) {
        return TEXTURE;
    }

    @Override
    public void render(LargeMagicJarEntity largeMagicJarEntity, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        ...
        p_225623_4_.popPose();
        super.render(largeMagicJarEntity, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
    }
}