...
public class DesertVoeLeggingsModel extends BipedModel<LivingEntity>
{
	...
	public DesertVoeLeggingsModel()
	{
		...
		body.texOffs(12, 37).addBox(-0.95F, -14.45F, -2.56F, 2.0F, 2.0F, 0.0F, 0.0F, false);
		body.texOffs(21, 47).addBox(3.55F, -13.95F, -1.55F, 1.0F, 1.0F, 3.0F, 0.0F, false);
		body.texOffs(28, 22).addBox(-4.45F, -13.95F, 1.45F, 9.0F, 1.0F, 1.0F, 0.0F, false);
		body.texOffs(12, 9).addBox(-4.45F, -13.95F, -1.55F, 1.0F, 1.0F, 3.0F, 0.0F, false);
		body.texOffs(28, 20).addBox(-4.45F, -13.95F, -2.55F, 9.0F, 1.0F, 1.0F, 0.0F, false);
		
		Body_r1 = new ModelRenderer(this);
		Body_r1.setPos(0.05F, -12.25F, -2.0F);
		...
		Body_r5.setPos(2.85F, -9.5F, 2.25F);
		...
		Body_r6.setPos(0.4399F, -11.3714F, -0.1F);
		...
		Body_r7.setPos(2.2041F, -9.2857F, 0.0F);
