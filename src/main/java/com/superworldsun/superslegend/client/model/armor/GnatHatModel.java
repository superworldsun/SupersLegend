...
public class GnatHatModel extends BipedModel<LivingEntity>
{
	...
	public GnatHatModel()
	{
		...
		head.texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 2.0F, 8.0F, 0.2F, false);
		head.texOffs(0, 36).addBox(-0.5F, -8.3F, -4.2F, 1.0F, 2.0F, 1.0F, 0.2F, false);
		...
		cube_r5.texOffs(24, 0).addBox(-3.001F, -12.5F, -4.3F, 6.0F, 3.0F, 5.0F, 0.0F, false);
