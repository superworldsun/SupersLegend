...
public class SnowquillTunicModel extends BipedModel<LivingEntity>
{
	...
	public SnowquillTunicModel()
	{
		...
		leftArm.setPos(5.0F, 2.0F, 0.0063F);
		leftArm.texOffs(43, 11).addBox(-1.25F, 7.0F, -2.4813F, 5.0F, 1.0F, 5.0F, 0.0F, false);
		leftArm.texOffs(20, 17).addBox(-1F, -2.0F, -2.0063F, 4.0F, 11.0F, 4.0F, 0.1F, false);
		leftArm.texOffs(54, 56).addBox(2.6F, 4.8F, -2.0062F, 1.0F, 4.0F, 4.0F, 0.0F, false);
		leftArm.texOffs(24, 54).addBox(-1F, 3.5F, -2.0063F, 4.0F, 1.0F, 4.0F, 0.3F, false);
