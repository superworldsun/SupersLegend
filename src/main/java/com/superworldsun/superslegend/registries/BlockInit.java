...
public class BlockInit
{
	...
	public static final RegistryObject<Block> DINS_SACRED_PEDESTAL = BLOCKS.register("dins_sacred_pedestal", () -> new DinsSacredPedestal(AbstractBlock.Properties.of(Material.METAL).noOcclusion().lightLevel((state) -> 11)));
	public static final RegistryObject<Block> FARORES_SACRED_PEDESTAL = BLOCKS.register("farores_sacred_pedestal", () -> new FaroresSacredPedestal(AbstractBlock.Properties.of(Material.METAL).noOcclusion().lightLevel((state) -> 11)));
	public static final RegistryObject<Block> NAYRUS_SACRED_PEDESTAL = BLOCKS.register("nayrus_sacred_pedestal", () -> new NayrusSacredPedestal(AbstractBlock.Properties.of(Material.METAL).noOcclusion().lightLevel((state) -> 11)));
