...
public class BlockInit {
    ...
    public static final RegistryObject<Block> LOCKED_DUNGEON_DOOR = registerBlock("locked_dungeon_door",
            () -> new Block(BlockBehaviour.Properties.of().noLootTable().requiresCorrectToolForDrops().destroyTime(Integer.MAX_VALUE).explosionResistance(Integer.MAX_VALUE).sound(SoundType.METAL)));
    public static final RegistryObject<Block> BOSS_DOOR = registerBlock("boss_door",
            () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().destroyTime(5).explosionResistance(99).sound(SoundType.METAL)));
