...
public class SoundInit
{
	...
	public static final RegistryObject<SoundEvent> BUBBLEGLOOP_DISC = register("item.bubblegloop_disc.disc");
	public static final RegistryObject<SoundEvent> FOREST_TEMPLE_DISC = register("item.forest_temple_disc.disc");
	public static final RegistryObject<SoundEvent> FIRE_TEMPLE_DISC = register("item.fire_temple_disc.disc");
	public static final RegistryObject<SoundEvent> WATER_TEMPLE_DISC = register("item.water_temple_disc.disc");
	public static final RegistryObject<SoundEvent> SHADOW_TEMPLE_DISC = register("item.shadow_temple_disc.disc");
	public static final RegistryObject<SoundEvent> SPIRIT_TEMPLE_DISC = register("item.spirit_temple_disc.disc");
	public static final RegistryObject<SoundEvent> WOODFALL_TEMPLE_DISC = register("item.woodfall_temple_disc.disc");
	public static final RegistryObject<SoundEvent> SNOWHEAD_TEMPLE_DISC = register("item.snowhead_temple_disc.disc");
