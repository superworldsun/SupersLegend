...
public class VillagerTradesEvents
{
	...
	public static void addCustomTrades(VillagerTradesEvent event)
	{
		...
		if (event.getType() == VillagerProfession.ARMORER)
		{
			...
			level3Trades.add(createTrade(new ItemStack(ItemInit.GOLD_RUPEE.get(), 2),(new ItemStack(ItemInit.SILVER_RUPEE.get(), 1)) , new ItemStack(ItemInit.SACRED_SHIELD.get()), 1, 30, 0F));
	...
	public static void addCustomWanderingTrades(WandererTradesEvent event)
	{
		...
		rareTrades.add(createTrade(new ItemStack(ItemInit.GOLD_RUPEE.get(), 5), new ItemStack(ItemInit.MAGIC_FIRE_ARROW.get()), 1, 400, 5F));
		rareTrades.add(createTrade(new ItemStack(ItemInit.GOLD_RUPEE.get(), 5), new ItemStack(ItemInit.MAGIC_ICE_ARROW.get()), 1, 400, 5F));
	}
