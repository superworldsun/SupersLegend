...
public class VillagerTradeEvents
{
    ...
    private static VillagerTrades.ItemListing createTrade(ItemStack price, ItemStack result, int maxUses, int exp, float priceMultiplier)
    {
        return (trader, rand) -> new MerchantOffer(price, result, maxUses, exp, priceMultiplier);
    }

    private static VillagerTrades.ItemListing createTrade(ItemStack price1, ItemStack price2, ItemStack result, int maxUses, int exp, float priceMultiplier)
    {
