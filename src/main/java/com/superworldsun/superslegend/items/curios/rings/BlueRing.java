...
public class BlueRing extends RingItem {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        if (event.getEntity() instanceof Player) { // Check if the entity taking damage is a Player
            ...
            ItemStack stack = CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.BLUE_RING.get(), player).map(ImmutableTriple::getRight).orElse(ItemStack.EMPTY);
