...
public class PowerRingL1 extends RingItem {
    public PowerRingL1(Properties properties) {
    ...
    public static void livingDamageEvent(LivingDamageEvent event)
    {
        ...
        if (event.getSource().getDirectEntity() instanceof Player)
        {
            ...
            ItemStack stack = CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.POWER_RING_L1.get(), player).map(ImmutableTriple::getRight).orElse(ItemStack.EMPTY);
    ...
    public void appendHoverText(@NotNull ItemStack stack, Level worldIn, List<Component> tooltip, @NotNull TooltipFlag flagIn) {
        tooltip.add(Component.literal("1.5x Sword & Taken Damage").withStyle(ChatFormatting.RED));
