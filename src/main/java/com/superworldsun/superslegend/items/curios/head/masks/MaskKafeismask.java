...
public class MaskKafeismask extends Item implements ICurioItem
{
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/kafeis_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof KafeisMaskModel))
        {
            model = new KafeisMaskModel<>();
        }

        KafeisMaskModel<?> maskModel = (KafeisMaskModel<?>) this.model;
