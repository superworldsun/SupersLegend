...
public class PowerRingL3 extends Item implements ICurioItem {

    public PowerRingL3(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public static void livingDamageEvent(LivingDamageEvent event) {
        ...
        if (event.getSource().getDirectEntity() instanceof PlayerEntity) {
            ...
            ItemStack stack =
                    CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.POWER_RING_L3.get(), player).map(
