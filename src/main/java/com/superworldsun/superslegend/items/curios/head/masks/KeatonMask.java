...
import com.superworldsun.superslegend.client.model.armor.KeatonMaskModel;
...
public class KeatonMask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/keaton_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof KeatonMaskModel))
        {
            model = new KeatonMaskModel<>();
        }

        KeatonMaskModel<?> maskModel = (KeatonMaskModel<?>) this.model;
