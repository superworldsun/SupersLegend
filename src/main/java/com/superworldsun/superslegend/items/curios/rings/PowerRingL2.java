...
public class PowerRingL2 extends RingItem {
    public PowerRingL2(Properties properties) {
    ...
    public static void livingDamageEvent(LivingDamageEvent event)
    {
        ...
        if (event.getSource().getDirectEntity() instanceof Player)
        {
            ...
            ItemStack stack = CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.POWER_RING_L2.get(), player).map(ImmutableTriple::getRight).orElse(ItemStack.EMPTY);
