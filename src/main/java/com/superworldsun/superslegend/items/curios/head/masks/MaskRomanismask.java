...
import com.superworldsun.superslegend.client.model.armor.RomanisMaskModel;
...
public class MaskRomanismask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/romanis_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof RomanisMaskModel))
        {
            model = new RomanisMaskModel<>();
        }

        RomanisMaskModel<?> maskModel = (RomanisMaskModel<?>) this.model;
