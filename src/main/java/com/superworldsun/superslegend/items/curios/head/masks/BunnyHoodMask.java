...
public class BunnyHoodMask extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        tooltip.add(Component.literal("I am Speed").withStyle(ChatFormatting.YELLOW));
        tooltip.add(Component.literal("Grants a boost of speed").withStyle(ChatFormatting.GREEN));
