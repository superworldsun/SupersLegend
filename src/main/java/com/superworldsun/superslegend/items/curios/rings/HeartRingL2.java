...
public class HeartRingL2 extends Item implements ICurioItem {

    public HeartRingL2(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack) {
        ...
        ItemStack ring =
                CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.HEART_RING_L2.get(), player).map(
