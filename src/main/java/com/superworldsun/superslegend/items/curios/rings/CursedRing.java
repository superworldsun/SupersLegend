...
public class CursedRing extends Item implements ICurioItem {
    ...
    public CursedRing(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntityLiving() instanceof PlayerEntity) {
            ...
            ItemStack stack =
                    CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.CURSED_RING.get(), player).map(
    ...
    public void appendHoverText(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
    {
        ...
        list.add(new StringTextComponent(TextFormatting.DARK_GRAY + "2x Damage Taken"));
    }
}