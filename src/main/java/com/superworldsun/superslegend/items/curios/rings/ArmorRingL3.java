...
public class ArmorRingL3 extends RingItem
{	
	public ArmorRingL3()
	{
	...
	public static void livingDamageEvent(LivingDamageEvent event)
	{
		...
		{			
			...
			ItemStack stack = CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.ARMOR_RING_L3.get(), player).map(ImmutableTriple::getRight).orElse(ItemStack.EMPTY);
	...
	public void appendHoverText(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
	{
		...
		list.add(new StringTextComponent(TextFormatting.BLUE + "2.5x Sword Attack & Damage Reduced"));
	}
}