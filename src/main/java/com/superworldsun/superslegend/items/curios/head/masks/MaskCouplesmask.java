...
import com.superworldsun.superslegend.client.model.armor.CouplesMaskModel;
...
public class MaskCouplesmask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/couples_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof CouplesMaskModel))
        {
            model = new CouplesMaskModel<>();
        }

        CouplesMaskModel<?> maskModel = (CouplesMaskModel<?>) this.model;
