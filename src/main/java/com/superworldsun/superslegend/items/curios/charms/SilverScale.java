...
public class SilverScale extends NonEnchantItem implements ICurioItem {
    public SilverScale(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack)
    {
        ...
        if (!charm.isEmpty()) {
            ...
            {
                player.addEffect(new MobEffectInstance(MobEffects.WATER_BREATHING, 215, 0, false, false, false));
            }
        }
    }
}
