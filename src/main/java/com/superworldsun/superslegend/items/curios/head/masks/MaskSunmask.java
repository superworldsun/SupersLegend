...
import com.superworldsun.superslegend.client.model.armor.SunMaskModel;
...
public class MaskSunmask extends NonEnchantItem implements ICurioItem {
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/sun_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof SunMaskModel))
        {
            model = new SunMaskModel<>();
        }

        SunMaskModel<?> maskModel = (SunMaskModel<?>) this.model;
