...
import com.superworldsun.superslegend.client.model.armor.GarosMaskModel;
...
public class MaskGarosmask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/garos_mask.png");

    public MaskGarosmask(Properties properties) {
        super(properties);
    }
    ...
    {
        // put your model here
        if (!(this.model instanceof GarosMaskModel))
        {
            model = new GarosMaskModel<>();
        }

        GarosMaskModel<?> maskModel = (GarosMaskModel<?>) this.model;
