...
public class GreenRing extends Item implements ICurioItem {

    public GreenRing(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public static void livingDamageEvent(LivingDamageEvent event) {
        ...
        if (event.getSource().getDirectEntity() instanceof PlayerEntity) {
            ...
            ItemStack stack =
                    CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.GREEN_RING.get(), player).map(
