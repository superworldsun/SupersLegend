...
public class ScentsMask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/mask_of_scents.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof MaskOfScentsModel))
        {
            model = new MaskOfScentsModel<>();
        }

        MaskOfScentsModel<?> maskModel = (MaskOfScentsModel<?>) this.model;
