...
public class ArmorRingL1 extends Item implements ICurioItem {

    public ArmorRingL1(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public static void livingDamageEvent(LivingDamageEvent event) {
        ...
        if (event.getSource().getDirectEntity() instanceof PlayerEntity) {
            ...
            ItemStack stack =
                    CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.ARMOR_RING_L1.get(), player).map(
    ...
    public void appendHoverText(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
    {
        ...
        list.add(new StringTextComponent(TextFormatting.BLUE + "1.5x Sword Attack & Damage Reduced"));
    }
}