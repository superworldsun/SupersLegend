...
import com.superworldsun.superslegend.client.model.armor.GreatfairyMaskModel;
...
public class MaskGreatfairymask extends NonEnchantItem implements ICurioItem
{
    @OnlyIn(Dist.CLIENT)
    private Object model;
    // put your texture here
    private static final ResourceLocation TEXTURE = new ResourceLocation(SupersLegendMain.MOD_ID, "textures/models/armor/greatfairy_mask.png");
    ...
    {
        // put your model here
        if (!(this.model instanceof GreatfairyMaskModel))
        {
            model = new GreatfairyMaskModel<>();
        }

        GreatfairyMaskModel<?> maskModel = (GreatfairyMaskModel<?>) this.model;
