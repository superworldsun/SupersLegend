...
public class GreenLuckRing extends Item implements ICurioItem {

    public GreenLuckRing(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntityLiving() instanceof PlayerEntity) {
            ...
            ItemStack stack =
                    CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.GREEN_LUCK_RING.get(), player).map(
