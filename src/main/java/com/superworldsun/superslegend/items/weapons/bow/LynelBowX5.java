...
public class LynelBowX5 extends BowItem {
    ...
    /*public LynelBowX5(int shotType, Properties builder) {
        super(builder);
    ...
    public LynelBowX5(Properties builder) {
        super(builder);
            ...
            if (!((double)f < 0.1D)) {
                ...
                if (shotType == 1){
                    ...
                    if (!levelIn.isClientSide) {
                        ...
                        AbstractArrow abstractarrowentity = arrowitem.createArrow(levelIn, itemstack, playerentity);
                        abstractarrowentity = customArrow(abstractarrowentity);
                        abstractarrowentity.shootFromRotation(playerentity, playerentity.xRotO, playerentity.yRotO + 4, 0.0F, f * velocity, inaccuracy);
                        if (f == 1.0F) {abstractarrowentity.setCritArrow(true);}
                        stack.hurtAndBreak(1, playerentity, (p_220009_1_) -> p_220009_1_.broadcastBreakEvent(playerentity.getUsedItemHand()));
                        abstractarrowentity.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
                        levelIn.addFreshEntity(abstractarrowentity);
                    ...
                    if (!levelIn.isClientSide) {
                        ...
                        AbstractArrow abstractarrowentity = arrowitem.createArrow(levelIn, itemstack, playerentity);
                        abstractarrowentity = customArrow(abstractarrowentity);
                        abstractarrowentity.shootFromRotation(playerentity, playerentity.xRotO, playerentity.yRotO -8, 0.0F, f * velocity, inaccuracy);
                        if (f == 1.0F) {abstractarrowentity.setCritArrow(true);}
                        stack.hurtAndBreak(1, playerentity, (p_220009_1_) -> p_220009_1_.broadcastBreakEvent(playerentity.getUsedItemHand()));
                        abstractarrowentity.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
                        levelIn.addFreshEntity(abstractarrowentity);
                ...
                levelIn.playSound(null,
                        playerentity.xo, playerentity.yo, playerentity.zo, SoundEvents.ARROW_SHOOT, SoundSource.PLAYERS,
