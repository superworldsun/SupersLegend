...
public class LynelBowX5 extends MultishotBowItem {
	...
	public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
		if(!Screen.hasShiftDown()) {
			...
			tooltip.add(Component.literal("This bow unleashes a barrage of 5 arrows with each shot").withStyle(ChatFormatting.WHITE).withStyle(ChatFormatting.ITALIC));
			tooltip.add(Component.literal("The bow can use any arrow as ammo").withStyle(ChatFormatting.GRAY));
			tooltip.add(Component.literal("Uses 5 durability with each shot").withStyle(ChatFormatting.GRAY));
		}
