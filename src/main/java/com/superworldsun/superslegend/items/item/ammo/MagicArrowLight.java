...
public class MagicArrowLight extends MagicArrow
{
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        if(!Screen.hasShiftDown()) {
            tooltip.add(Component.literal("Infuses the power of Light to Arrows").withStyle(ChatFormatting.YELLOW));
            ...
            tooltip.add(Component.literal("Uses magic and turns a regular arrow into light arrows when fired").withStyle(ChatFormatting.DARK_RED));
