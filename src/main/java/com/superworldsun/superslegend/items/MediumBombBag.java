...
public class MediumBombBag extends Item {
	public static int STORAGE = 40;
	...
	public static void onItemPickup(EntityItemPickupEvent event) {
		...
		ItemStack stack0 = CuriosApi.getCuriosHelper().findEquippedCurio(ItemInit.BIG_BOMB_BAG.get(), (LivingEntity) event.getEntity()).map(ImmutableTriple::getRight).orElse(ItemStack.EMPTY);
