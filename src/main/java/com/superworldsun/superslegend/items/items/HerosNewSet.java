...
public class HerosNewSet extends Item
{
	public HerosNewSet()
	{
	...
	public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand)
	{
		...
		addOrDrop(player, ItemInit.HEROS_NEW_CAP);
		addOrDrop(player, ItemInit.HEROS_NEW_TUNIC);
		addOrDrop(player, ItemInit.HEROS_NEW_LEGGINGS);
		addOrDrop(player, ItemInit.HEROS_NEW_BOOTS);
