...
public class BlackPushStoneItem extends ModBlockItem
{
	public BlackPushStoneItem(RegistryObject<Block> blockObject)
	{
		super(blockObject);
	}
	...
	public void appendHoverText(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
	{
		...
		list.add(new StringTextComponent(TextFormatting.GOLD + "Requires Golden Gauntlets to push"));
