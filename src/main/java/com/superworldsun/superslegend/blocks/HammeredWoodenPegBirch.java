...
public class HammeredWoodenPegBirch extends Block

{

	protected static final VoxelShape SHAPE = Block.box(3.75D, 0.0D, 3.75D, 12.25D, 1.0D, 12.25D);

	public HammeredWoodenPegBirch(Properties properties) {
		super(properties);
	}
	...
	{
		{
			worldIn.setBlockAndUpdate(pos, BlockInit.BIRCH_PEG_BLOCK.get().defaultBlockState());
	...
	public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult rayTraceResult)
	{
		...
		world.playSound(null, currentPos.getX(), currentPos.getY(), currentPos.getZ(), SoundEvents.WOOD_HIT, SoundCategory.PLAYERS, 1f, 1f);
			...
			world.setBlock(pos, BlockInit.BIRCH_PEG_BLOCK.get().defaultBlockState(), 3);
