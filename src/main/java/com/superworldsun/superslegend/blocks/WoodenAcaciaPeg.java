...
public class WoodenAcaciaPeg extends Block {
    ...
    public WoodenAcaciaPeg(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void attack(BlockState state, Level world, BlockPos pos, Player player)
    {
                ...
                || player.isHolding(ItemInit.SKULL_HAMMER.get()))
        {
            ...
            world.setBlock(pos, BlockInit.HAMMERED_WOODEN_PEG_ACACIA.get().defaultBlockState(), 3);
        }
