...
public class WoodenOakPeg extends Block {
    ...
    public WoodenOakPeg(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void attack(BlockState state, Level world, BlockPos pos, Player player)
    {
                ...
                || player.isHolding(ItemInit.SKULL_HAMMER.get()))
        {
            ...
            world.setBlock(pos, BlockInit.HAMMERED_WOODEN_PEG_OAK.get().defaultBlockState(), 3);
        }
