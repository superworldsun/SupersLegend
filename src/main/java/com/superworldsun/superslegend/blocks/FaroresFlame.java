...
public class FaroresFlame extends Block {
    ...
    @Override
    public void entityInside(@NotNull BlockState state, @NotNull Level worldIn, @NotNull BlockPos pos, net.minecraft.world.entity.@NotNull Entity entity) {
        if(entity instanceof ItemEntity) {
            ItemEntity itemEntity = (ItemEntity) entity;
            ItemStack stack = itemEntity.getItem();
            ItemStack newsword = new ItemStack(ItemInit.GODDESS_LONGSWORD.get());
            ItemEntity sword = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), newsword);
            if(stack.getItem() == ItemInit.GODDESS_SWORD.get()) {
