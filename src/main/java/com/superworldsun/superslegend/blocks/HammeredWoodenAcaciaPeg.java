...
public class HammeredWoodenAcaciaPeg extends Block

{

    protected static final VoxelShape SHAPE = Block.box(3.75D, 0.0D, 3.75D, 12.25D, 1.0D, 12.25D);

    public HammeredWoodenAcaciaPeg(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(@NotNull BlockState state, @NotNull ServerLevel level, @NotNull BlockPos pos, @NotNull RandomSource random)
    {
        ...
        {
            level.setBlockAndUpdate(pos, BlockInit.ACACIA_PEG_BLOCK.get().defaultBlockState());
    ...
    public @NotNull InteractionResult use(@NotNull BlockState state, Level level, @NotNull BlockPos pos, Player player, @NotNull InteractionHand hand, @NotNull BlockHitResult hit)
    {
        ...
        level.setBlock(pos, BlockInit.ACACIA_PEG_BLOCK.get().defaultBlockState(), 3);
