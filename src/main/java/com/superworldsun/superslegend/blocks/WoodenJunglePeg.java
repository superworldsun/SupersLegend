...
public class WoodenJunglePeg extends Block {
    ...
    public WoodenJunglePeg(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void attack(BlockState state, Level world, BlockPos pos, Player player)
    {
                ...
                || player.isHolding(ItemInit.SKULL_HAMMER.get()))
        {
            ...
            world.setBlock(pos, BlockInit.HAMMERED_WOODEN_PEG_JUNGLE.get().defaultBlockState(), 3);
        }
