package superworldsun.superslegend.entities.projectiles.items.dinsfire;
...
/*public class EntityDinsFire extends Entity {
    ...
    public EntityDinsFire(EntityType<EntityDinsFire> type, World world) {
        super(type, world);
    ...
    public EntityDinsFire(EntityType<EntityDinsFire> type, World worldIn, PlayerEntity entity, ItemStack itemstack, Hand hand) {
        this(type, worldIn);
    ...
    public DamageSource causeNewDamage(EntityDinsFire entityDinsFire, Entity entity) {
        return null;
    }
