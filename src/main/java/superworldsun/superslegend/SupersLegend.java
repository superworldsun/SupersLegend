		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event)
		{
			...
			(	
				//Blocks
					...
					BlockList.spikes_block = new SpikesBlock(Block.Properties.create(Material.IRON).notSolid().hardnessAndResistance(13.0f, 13.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("spikes_block")),
					BlockList.gossip_stone_block = new GossipStoneBlock(Block.Properties.create(Material.ROCK).notSolid().hardnessAndResistance(1.0f, 1.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("gossip_stone_block")),
					...
					BlockList.chain_link_fence_block = new ChainLinkFenceBlock(Block.Properties.create(Material.IRON).notSolid().hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("chain_link_fence_block")),
					...
					BlockList.grate_block = new GrateBlock(Block.Properties.create(Material.IRON).notSolid().hardnessAndResistance(3.0f, 3.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("grate_block")),
