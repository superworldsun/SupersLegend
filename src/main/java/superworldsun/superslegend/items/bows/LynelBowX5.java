            ...
            if (!((double)f < 0.1D)) {
                ...
                if (shotType == 1){
                    ...
                    if (!worldIn.isClientSide) {
                        ...
                        AbstractArrowEntity abstractarrowentity = arrowitem.createArrow(worldIn, itemstack, playerentity);
                        abstractarrowentity = customArrow(abstractarrowentity);
                        abstractarrowentity.shootFromRotation(playerentity, playerentity.xRot, playerentity.yRot + 4, 0.0F, f * velocity, inaccuracy);
                        if (f == 1.0F) {abstractarrowentity.setCritArrow(true);}
                        stack.hurtAndBreak(1, playerentity, (p_220009_1_) -> p_220009_1_.broadcastBreakEvent(playerentity.getUsedItemHand()));
                        abstractarrowentity.pickup = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
                        worldIn.addFreshEntity(abstractarrowentity);
                    ...
                    if (!worldIn.isClientSide) {
                        ...
                        AbstractArrowEntity abstractarrowentity = arrowitem.createArrow(worldIn, itemstack, playerentity);
                        abstractarrowentity = customArrow(abstractarrowentity);
                        abstractarrowentity.shootFromRotation(playerentity, playerentity.xRot, playerentity.yRot -8, 0.0F, f * velocity, inaccuracy);
                        if (f == 1.0F) {abstractarrowentity.setCritArrow(true);}
                        stack.hurtAndBreak(1, playerentity, (p_220009_1_) -> p_220009_1_.broadcastBreakEvent(playerentity.getUsedItemHand()));
                        abstractarrowentity.pickup = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
                        worldIn.addFreshEntity(abstractarrowentity);
                ...
                worldIn.playSound(null,
                        playerentity.xo, playerentity.yo, playerentity.zo, SoundEvents.ARROW_SHOOT, SoundCategory.PLAYERS,
