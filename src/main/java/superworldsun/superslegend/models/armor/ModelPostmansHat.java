...
public class ModelPostmansHat<T extends LivingEntity> extends BipedModel<T> {
    ...
    //public ModelRenderer modelPostmansHat;
    ...
    public ModelPostmansHat() {
        ...
        bipedHead.setTextureOffset(0, 0)
                .addBox(-5.0F, -12.0F, -3.0F, 10.0F, 1.0F, 8.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 9)
                .addBox(-4.5F, -8.475F, -5.05F, 5.0F, 1.0F, 10.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 20)
                .addBox(0.5F, -8.475F, -5.075F, 4.0F, 1.0F, 10.0F, 0.0F, false);
        bipedHead.setTextureOffset(40, 18)
                .addBox(4.0F, -11.0F, -3.5F, 1.0F, 3.0F, 8.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 4)
                .addBox(4.0F, -9.5F, -4.5F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 0)
                .addBox(-5.0F, -9.5F, -4.5F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(4, 0)
                .addBox(4.0F, -10.5F, -3.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        bipedHead.setTextureOffset(4, 4)
                .addBox(-5.0F, -10.5F, -3.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        bipedHead.setTextureOffset(38, 1)
                .addBox(4.5F, -8.0F, -5.0F, 1.0F, 1.0F, 10.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 31)
                .addBox(-5.5F, -8.0F, -5.0F, 1.0F, 1.0F, 10.0F, 0.0F, false);
        bipedHead.setTextureOffset(14, 39)
                .addBox(-5.0F, -11.0F, -3.5F, 1.0F, 3.0F, 8.0F, 0.0F, false);

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(1.0F, -7.0F, 5.0F);
        bipedHead.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, -1.5708F, 0.0F);
        cube_r1.setTextureOffset(18, 26)
                .addBox(-1.0F, -4.0F, -4.0F, 1.0F, 3.0F, 10.0F, 0.0F, false);
