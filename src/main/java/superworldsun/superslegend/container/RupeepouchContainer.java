package superworldsun.superslegend.container;
...
public class RupeepouchContainer extends UContainer {
	
	private final IInventory backpackInventory;
	private final Backpack backpack;
	
	public static RupeepouchContainer createClientContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
		final Backpack backPack = buffer.readEnumValue(Backpack.class);
		return new RupeepouchContainer(id, playerInventory, backPack);
	}
	
	private RupeepouchContainer(int id, PlayerInventory playerInventory, Backpack backpack) {
		this(id, playerInventory, new Inventory(backpack.getInventorySize()), backpack);
	}
	
	public RupeepouchContainer(int id, PlayerInventory playerInventory, IInventory backpackInventory, Backpack backpack) {
