package superworldsun.superslegend.ModelingAPI.helpers.container;
...
public class VanillaTabulaModel implements IUnbakedModel {
    ...
    public VanillaTabulaModel(TabulaModelContainer model, Material particle, ImmutableList<RenderMaterial> textures, ImmutableMap<ItemCameraTransforms.TransformType, TransformationMatrix> transforms) {
        this.model = model;
