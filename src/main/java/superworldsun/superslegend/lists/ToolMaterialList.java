...
public enum ToolMaterialList implements IItemTier
{
	//Weapons
		...
		orange_rupee_axe	(3, 5f, 1244, 3, 0, ItemList.orange_rupee_axe),
		...
		orange_rupee_shovel		(3, 5f, 1244, 3, 0, ItemList.orange_rupee_shovel),
		...
		orange_rupee_hoe(3, 5f, 1300, 3, 0, ItemList.orange_rupee_hoe);
