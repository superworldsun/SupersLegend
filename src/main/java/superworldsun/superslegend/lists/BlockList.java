...
public class BlockList 
{
	...
	public static Block dins_flame;
	public static Block farores_flame;
	public static Block nayrus_flame;
	public static Block lantern_light_block;

	public static Block deku_sapling;
	public static Block deku_wood;
	public static Block deku_leaves;
	public static Block deku_log;
